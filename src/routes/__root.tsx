  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <Link to="/" className="mt-6 inline-flex items-center justify-center rounded-xl bg-orange px-6 py-2.5 text-sm font-semibold text-white hover:bg-orange-light transition-colors">
          Go Home
        </Link>
      </div>
    </div>
